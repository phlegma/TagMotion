...
namespace TagLib.Mpeg
{
    ...
    public struct AudioHeader : IAudioCodec
    {
        ...
        /// <summary>
        ///    Contains the position where the header was found.
        /// </summary>
        ...
        public void Save(TagLib.File file)
        {
            ...
            ByteVector data = new ByteVector(buf);

            //file.RemoveBlock(this.position, 4);
